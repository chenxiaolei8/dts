...
/**
 * com.jd.chen.dts.plugins.writer.mysqlWriter.MysqlWriter
...
public class MysqlWriter extends AbstractPlugin implements IWriter {
    ...
    private static Log logger = LogFactory.getLog(MysqlWriter.class);
    ...
    public void init() {
        ...
        if (!"insert".equalsIgnoreCase(operation)
            ...
            throw new DTSException("operation " + operation
    ...
    public void write(ILineReceiver receiver) {
        ...
        try {
            ...
            throw new DTSException(e, JobStatus.WRITE_FAILED.getStatus()
