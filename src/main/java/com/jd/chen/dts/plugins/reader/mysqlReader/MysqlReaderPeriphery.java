...
public class MysqlReaderPeriphery implements IReaderPeriphery {
    ...
    private Log log = LogFactory.getLog(MysqlReaderPeriphery.class);
    ...
    public void prepare(IParam param, ISourceCounter counter) {
        ...
        try {
            ...
            log.info("Source data size: " + size + " lines.");
        } catch (Exception e) {
            log.error("Cannot get result set size!");
    ...
    private Properties createProperties() {
        ...
        log.debug(String.format("MysqlReader try connection: %s .", url));
        return p;
    }
}
