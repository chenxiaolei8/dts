...
import com.jd.chen.dts.common.lord.impl.DefaultPluginMonitor;
...
public class MonitorManager implements ISourceCounter, ITargetCounter {
    ...
    public DTSJobInfo getJobInfo(String dataSource, String dataTarget, long time, int status, Date start) {
        CompletedMonitorInfo info = getCompletedMonitorInfo();
        ...
        return new DTSJobInfo(userName, dataSource, dataTarget, start, totalLines, totalBytes, time, status);
    }
}
